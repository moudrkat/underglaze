...
window.wall = {
  ...
  async perform(ms=95){
    ...
    // A pass cut off by stop() leaves its tile part-way along its slider. The
    // wall is meant to be found the way it was left, so anything still lit is
    // put back -- unless a question has taken the wall over, in which case the
    // tile belongs to whoever asked.
