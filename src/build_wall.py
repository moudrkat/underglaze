...
# tiles and nothing else: 0.12 lands 104 of them, against 92 at the 0.20 this
# page used to run at. Higher refuses nonsense better and answers real
# questions worse; 0.12 is where the two stop paying for each other.
THRESHOLD = 0.12
